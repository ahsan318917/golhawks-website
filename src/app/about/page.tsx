      ...
      <section className="pt-32 md:pt-48 pb-14 md:pb-24 border-b border-zinc-800 bg-gradient-to-b from-black via-zinc-950 to-zinc-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="text-red-500 font-black uppercase tracking-[0.4em] text-xs mb-8 block">Our Legacy</span>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
            <motion.div
              ...
              className="rounded-[2.5rem] md:rounded-[3rem] overflow-hidden aspect-square border border-zinc-700 group relative shadow-2xl"
            >
              <img 
            ...
            >
              <div>
                ...
                <p className="p-lg text-zinc-200">
              ...
              <div className="grid grid-cols-2 gap-8 md:gap-10">
                <div className="space-y-2 group">
                  ...
                  <p className="p-sm text-zinc-300">Defining batch protocols that ensure every unit is identical.</p>
                </div>
                <div className="space-y-2 group">
                  ...
                  <p className="p-sm text-zinc-300">Treating textile manufacturing as a science, not a craft.</p>
                </div>
              </div>
              
              <div className="pt-10 border-t border-zinc-800">
                <blockquote className="text-xl md:text-2xl font-bold italic text-zinc-300 tracking-tight leading-relaxed">
