      ...
      <section className="pt-32 md:pt-48 pb-14 md:pb-24 border-b border-white/5 bg-gradient-to-b from-black via-zinc-950 to-zinc-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="text-brand-red font-black uppercase tracking-[0.4em] text-[10px] mb-8 block">Contact Authority</span>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            <motion.div 
              ...
              className="space-y-4"
            >
              <div className="text-brand-red font-black uppercase tracking-widest text-[10px]">Production Hub</div>
              <div className="flex items-start gap-4">
                <MapPin className="w-5 h-5 text-white/40 shrink-0" />
                <p className="text-zinc-400 font-medium uppercase tracking-tight text-sm">
            ...
            <motion.div 
              ...
              className="space-y-4"
            >
              <div className="text-brand-red font-black uppercase tracking-widest text-[10px]">Business Email</div>
              <div className="flex items-start gap-4">
                <Mail className="w-5 h-5 text-white/40 shrink-0" />
                <a href="mailto:info@golhawksinternational.com" className="text-zinc-400 font-medium hover:text-white transition-colors text-sm uppercase">
            ...
            <motion.div 
              ...
              className="space-y-4"
            >
              <div className="text-brand-red font-black uppercase tracking-widest text-[10px]">Direct Support</div>
              <div className="flex items-start gap-4">
                <FaWhatsapp className="w-5 h-5 text-white/40 shrink-0" />
                <a href="https://wa.me/923464208200" className="text-zinc-400 font-medium hover:text-white transition-colors text-sm uppercase">
                  +92 346 4208200
                </a>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="space-y-4"
            >
              <div className="text-brand-red font-black uppercase tracking-widest text-[10px]">Response Protocol</div>
              <div className="flex items-start gap-4">
                <Clock className="w-5 h-5 text-white/40 shrink-0" />
                <p className="text-zinc-400 font-medium text-sm uppercase tracking-tight">
