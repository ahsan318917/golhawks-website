...
const categories = [
  ...
  },
  {
    ...
    tech: "Premium Selvedge • Custom Wash • OEM Production",
  },
  {
  ...
  },
  {
    ...
    tech: "Heavy Fleece • Urban Sets • Tech Apparel",
  },
];
    ...
    <section className="section-padding bg-gradient-to-b from-zinc-950 via-black to-zinc-900 relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <motion.div 
          ...
          className="flex flex-col md:flex-row md:items-end justify-between mb-10 md:mb-24 gap-6 md:gap-10"
        >
          <div>
            <span className="text-red-500 font-black uppercase tracking-[0.2em] md:tracking-[0.4em] text-[7px] md:text-[10px] mb-2 md:mb-6 block">Product Range</span>
            <h2 className="text-[2.5rem] sm:text-6xl md:text-8xl lg:text-[10rem] font-black leading-[0.9] tracking-tighter uppercase text-white">BATTLE <br /><span className="text-zinc-800 italic">READY</span></h2>
          </div>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link href="/products" className="group flex items-center gap-3 text-white hover:text-red-500 transition-all font-black uppercase tracking-[0.2em] text-[8px] md:text-[10px] border-b border-white/10 pb-2 md:pb-4 w-fit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
          {categories.map((cat, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-5 md:p-12 w-full transform md:group-hover:translate-y-[-10px] transition-transform duration-700">
                <p className="text-red-500 font-black text-[7px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-[0.4em] mb-1 md:mb-4">
                  {cat.tech}
                </p>
                <h3 className="text-xl md:text-5xl font-black text-white leading-none tracking-tighter uppercase">
                  {cat.title}
                </h3>
              </div>
            </motion.div>
