    ...
    <section id="services" className="py-16 md:py-32 bg-brand-gray/30 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="text-center mb-12 md:mb-24">
          <span className="text-brand-red font-black uppercase tracking-[0.4em] text-xs mb-8 block">B2B Core Systems</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="mb-3 md:mb-12 p-4 md:p-6 bg-zinc-950 border border-zinc-800 rounded-[1.5rem] md:rounded-[2rem] w-fit group-hover:border-brand-red/40 transition-all duration-700 relative z-10">
              ...
              <div className="pt-3 md:pt-8 border-t border-zinc-800 relative z-10">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-red/60 group-hover:text-brand-red transition-colors">
                  {service.meta}
                </p>
              </div>
            </motion.div>
