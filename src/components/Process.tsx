...
const Process = () => {
  ...
  return (
    <section id="process" className="py-20 md:py-32 bg-brand-black" ref={containerRef}>
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-16 md:mb-24">
          <span className="text-brand-red font-black uppercase tracking-[0.2em] md:tracking-[0.4em] text-[8px] md:text-[10px] mb-4 md:mb-6 block">The System</span>
