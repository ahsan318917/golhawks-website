...
const WhatsAppButton = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[100] bg-green-500 text-white p-3.5 md:p-5 rounded-full shadow-2xl flex items-center justify-center group border border-white/20"
    >
